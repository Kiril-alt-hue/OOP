...
if __name__ == "__main__":
    ...
    try:
        ...
        # Коректні операції
        print(f"Додавання: {r1 + r2}")
        print(f"Віднімання: {r1 - r2}")
        print(f"Множення: {r1 * r2}")
        print(f"Ділення: {r1 / r2}")

        # Операції з помилками
        print("Спробуємо операції з некоректними типами:")
        try:
            print(r1 + "2")
        ...
        # Нулевий знаменник при створенні
        try:
            bad = Rational(1, 0)
        except ZeroDivisonDenominatorError as e:
            print(f"Помилка: {e}")
